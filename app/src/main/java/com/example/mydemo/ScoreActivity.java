...
import com.example.mydemo.databinding.ActivityScoreBinding;

public class ScoreActivity extends AppCompatActivity {
    ScoreViewModel scoreViewModel;
    ActivityScoreBinding mainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainBinding = DataBindingUtil.setContentView(this, R.layout.activity_score);
